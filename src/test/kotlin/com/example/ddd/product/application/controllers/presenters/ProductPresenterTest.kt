...
class ProductPresenterTest {
    ...
    fun `should map a product to a product response`() {
        val product = Product("prd-1", "Beer", "Enjoy your day with a nice cold beer")
        val expectedProductResponse = ProductResponse("prd-1", "Beer", "Enjoy your day with a nice cold beer")
